  ...
  const contactMethods = [
    {
      icon: Phone,
      title: 'Call Us',
      details: ['+91 99888 92587', '+91 99888 92510'],
      action: { text: 'Call Now', href: 'tel:+919988892587' }
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['info@greymattersgroup.org', 'support@greymattersgroup.org'],
      action: { text: 'Send Email', href: 'mailto:info@greymattersgroup.org' }
    },
    {
      icon: MessageCircle,
      title: 'WhatsApp',
      details: ['+91 99888 92510', 'Quick responses guaranteed'],
      action: { text: 'Chat Now', href: 'https://wa.me/919988892510' }
    },
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['S.C.O. 63-64, Sector 17C', 'Chandigarh - 160017'],
      action: { text: 'Get Directions', href: 'https://maps.app.goo.gl/3D1Z9GArs92jZ2NR6' }
    }
  ];

  const offices = [
    { city: 'New Delhi', address: '123 Education Hub, Sector 15', phone: '+91 98765 43210' },
    { city: 'Mumbai', address: '456 Learning Center, Andheri West', phone: '+91 98765 43211' },
    { city: 'Bangalore', address: '789 Tech Park, Koramangala', phone: '+91 98765 43212' },
    { city: 'Hyderabad', address: '321 Study Point, Banjara Hills', phone: '+91 98765 43213' }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-slate-300 leading-relaxed">
              Have questions about our courses or immigration services? Our team is here to help you every step of the way.
            </p>
          </motion.div>
        </div>
      </section>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="h-12 text-base rounded-xl border-slate-300 focus:border-red-500 focus:ring-red-500"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="text-base rounded-xl border-slate-300 focus:border-red-500 focus:ring-red-500 resize-none"
                      />
                    </div>
                    ...
                    <Button
                      ...
                      className="w-full h-14 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white text-lg font-semibold rounded-xl shadow-lg shadow-red-500/30 hover:shadow-xl hover:shadow-red-500/40 transition-all duration-300"
                    >
                      {isSubmitting ? (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            description="We have offices across India to serve you better"
          />
            ...
            <div className="flex flex-wrap gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">9:00 AM - 6:00 PM</p>
                </div>
              </div>
